...
function HomePage() {
  ...
  return (
    ...
    <div className="home-page container">
      ...
      {role === 'Admin' ? <button type="button" onClick={() => addTeam()} className="btn btn-block btn-primary">
        Add Team
      </button> : ''}
      {role === 'Admin' ? <button type="button" onClick={() => addEvent()} className="btn btn-block btn-primary">
        Add Event
      </button> : ''}
